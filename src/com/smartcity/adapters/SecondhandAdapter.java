...
public class SecondhandAdapter extends BaseAdapter{
	...
	public SecondhandAdapter(Context context, ArrayList<SecondhandItems> items) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView=inflater.inflate(R.layout.custom_secondhand, null);
		}
		...
		SecondhandItems row_pos=items.get(position);
